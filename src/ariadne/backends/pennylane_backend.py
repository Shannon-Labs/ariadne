...
class VariationalCircuit:
    ...
    def __init__(self, backend: PennyLaneBackend, num_qubits: int, 
                 num_layers: int = 1, entangling_gate: str = 'cnot'):
        """
...
def create_pennylane_backend(device_name: str = 'default.qubit',
    ...
    """
    return PennyLaneBackend(device_name=device_name, shots=shots, 
        ...
        for num_layers in num_layers_list:
            ...
            try:
                ...
                def cost_function(params):
                    outputs = vqc.execute(params)
                    return sum(outputs)  # Sum of expectation values
