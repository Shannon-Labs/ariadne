...
from ariadne.types import SimulationResult, BackendType
...
class TestResultAnalyzer:
    ...
    def test_compare_backends(self):
        ...
        backend_results = {
            'stim': self.mock_result,
            'qiskit': self.mock_result
        }
...
class TestResultVisualizer:
    ...
    def setup_method(self):
        ...
        self.mock_result.backend_performance = {
            'gate_operations': 1000,
            'memory_usage': 50.5
        }
